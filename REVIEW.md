...
- PLAN.md:40: the plan still lists README.md as incomplete even though README.md now contains install instructions, a one-line example, and a SPEC.md link; stale done-state makes SPEC 9 verification unreliable.
